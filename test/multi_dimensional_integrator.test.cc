...
TEST_CASE("can use all algorithms to integrate a constant function over the "
          "unit square")
{
...
TEST_CASE("can use all algorithms to integrate a constant function over a "
          "specified area")
{
  cubacpp::turn_off_cuba_forking();
  auto flat_func = [](double, double) { return 1.0; };
...
TEST_CASE("can use named algorithms to integrate a constant function over the "
          "unit square")
{
  cubacpp::turn_off_cuba_forking();
  auto flat_func = [](double, double) { return 1.0; };
