...
#include "CosmoSISScalarEvaluatorModule.hh"
...
#define DEFINE_COSMOSIS_SCALAR_EVALUATOR_MODULE(klass)                         \
  using module_type = y3_cluster::CosmoSISScalarEvaluatorModule<klass>;        \
  extern "C" {                                                                 \
  void*                                                                        \
  setup(cosmosis::DataBlock* cfg)                                              \
  {                                                                            \
