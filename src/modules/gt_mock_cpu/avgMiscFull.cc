...
////
class avgMiscFullScalarIntegrand {
public:
...
public:
  ...
  explicit avgMiscFullScalarIntegrand(cosmosis::DataBlock& config);
...
avgMiscFullScalarIntegrand::avgMiscFullScalarIntegrand( DataBlock& cfg)
{
  auto rc = 
...
void
avgMiscFullScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
avgMiscFullScalarIntegrand::set_grid_point(
                        ...
                        double theta) const
{
  ...
  auto const val = (*gamma)(scaled_Rmis, lnM, zt) * roffset_v * (*lo_lc)(lo, lc, rmis) *
...
char const*
avgMiscFullScalarIntegrand::module_label()
{
  return "gammaMisc";
}
...
std::vector<avgMiscFullScalarIntegrand::volume_t>
avgMiscFullScalarIntegrand::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgMiscFullScalarIntegrand::module_label(),     
    "lo",
    "lc",
    "zt",
    "lnm",
...
avgMiscFullScalarIntegrand::grid_t
avgMiscFullScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgMiscFullScalarIntegrand)
