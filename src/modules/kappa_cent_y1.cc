...
// kappa_cent_y1 is a class that models the concept of "CosmoSISIntegrand",
...
public:
  ...
  explicit kappa_cent_y1(cosmosis::DataBlock& config);
...
std::vector<double>
kappa_cent_y1::operator()(double lo, double lt, double zt, double lnM) const
{
...
char const*
kappa_cent_y1::module_label()
{
  return "kappa_cent_y1";
}
...
DEFINE_COSMOSIS_MODULE(kappa_cent_y1);
