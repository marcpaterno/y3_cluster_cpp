...
// NCCentY1ScalarIntegrand is a class that models the concept of
...
public:
  ...
  explicit NCCentY1ScalarIntegrand(cosmosis::DataBlock& config);
...
NCCentY1ScalarIntegrand::NCCentY1ScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
NCCentY1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
double
NCCentY1ScalarIntegrand::operator()(double lo,
                             double lt,
                             double zt,
                             double lnM) const
{
...
char const*
NCCentY1ScalarIntegrand::module_label()
{
  return "NCCentY1ScalarIntegrand";
}
...
std::vector<NCCentY1ScalarIntegrand::volume_t>
NCCentY1ScalarIntegrand::make_integration_volumes(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, NCCentY1ScalarIntegrand::module_label(), "lo","lt", "zt", "lnm");
}

std::vector<NCCentY1ScalarIntegrand::grid_point_t>
