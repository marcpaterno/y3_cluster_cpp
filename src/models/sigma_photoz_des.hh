...
namespace y3_cluster {
    ...
    public:
        ...
        double operator()(double zt) const {
            double poly_coeff[]={-40358.8315, 2798.08304, 9333.80185, -657.348248, -840.565610,
                                 46.8506649, 37.8839498, -0.868811858, -0.808928182, 0.00890199353,
                                 0.0139811265};
            double _sigma=0;
            double z_for_fit=zt;
