...
// SnapshotScalarmaxSigmaIntegrand is a class that models the concept of
...
public:
  ...
  explicit SnapshotScalarmaxSigmaIntegrand(cosmosis::DataBlock& config);
...
SnapshotScalarmaxSigmaIntegrand::SnapshotScalarmaxSigmaIntegrand(DataBlock&)
  : hmf(), sigma(), radius_(), zt_()
{}

void
SnapshotScalarmaxSigmaIntegrand::set_sample(DataBlock& sample)
{
...
void
SnapshotScalarmaxSigmaIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
{
  return "SnapshotScalarmaxSigmaIntegrand";
}
