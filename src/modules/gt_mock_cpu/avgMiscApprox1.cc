...
//
class avgMiscApprox1ScalarIntegrand {
public:
...
public:
  ...
  explicit avgMiscApprox1ScalarIntegrand(cosmosis::DataBlock& config);
...
avgMiscApprox1ScalarIntegrand::avgMiscApprox1ScalarIntegrand( DataBlock& cfg)
{
  auto rc = 
...
void
avgMiscApprox1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
avgMiscApprox1ScalarIntegrand::set_grid_point(
...
double
avgMiscApprox1ScalarIntegrand::operator()(double lo,
                           double zt,
                           double lnM,
                           double rmis,
                           double theta) const
...
char const*
avgMiscApprox1ScalarIntegrand::module_label()
{
  return "gammaMisc";
}
...
std::vector<avgMiscApprox1ScalarIntegrand::volume_t>
avgMiscApprox1ScalarIntegrand::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgMiscApprox1ScalarIntegrand::module_label(),     
    "lo",
    "zt",
    "lnm",
    "rmis",
...
avgMiscApprox1ScalarIntegrand::grid_t
avgMiscApprox1ScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgMiscApprox1ScalarIntegrand)
