...
public:
  ...
  explicit avgMiscFullCardCPU(cosmosis::DataBlock& config);
...
avgMiscFullCardCPU::avgMiscFullCardCPU( DataBlock& cfg)
{
  auto rc = 
...
void
avgMiscFullCardCPU::set_sample(DataBlock& sample)
{
...
void
avgMiscFullCardCPU::set_grid_point(
...
double
avgMiscFullCardCPU::operator()(double lo,
                                       double lc,
                                       double lt,
                                       double zt,
                                       double lnM,
...
char const*
avgMiscFullCardCPU::module_label()
{
  return "gammaMisc";
}
...
std::vector<avgMiscFullCardCPU::volume_t>
avgMiscFullCardCPU::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgMiscFullCardCPU::module_label(),     
    "lo",
    "lc",
    "lt",
    "zt",
...
avgMiscFullCardCPU::grid_t
avgMiscFullCardCPU::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgMiscFullCardCPU)
