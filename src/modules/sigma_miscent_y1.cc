...
sigma_miscent_y1::sigma_miscent_y1(DataBlock& config) : 
	lc_lt(),
        ...
        lo_lc(),
        sigma(),
	zo_low_(config.view<std::vector<double>>(sigma_miscent_y1::module_label(), "zo_low")),
        zo_high_(config.view<std::vector<double>>(sigma_miscent_y1::module_label(), "zo_high")), 
        radii_(config.view<std::vector<double>>(sigma_miscent_y1::module_label(), "radii")){}
...
std::vector<double>
sigma_miscent_y1::operator()(double lo, double lc, double lt, double zt, double lnM, double rmis, double theta) const
{
