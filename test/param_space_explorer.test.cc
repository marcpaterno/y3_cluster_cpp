...
using y3_cluster::IntegrationRange, std::array, std::tuple, std::pair;
TEST_CASE("Param space explorer acts as expected")
{
  double a, b;
  IntegrationRange air{3.0, 11.0}, bir{-13.4, 19.3};

  ParamSpaceExplorer<2> pse2d({&a, &b}, {air, bir}, {4, 5});
  ...
  double c, d, e;
  IntegrationRange cir{-100, -1000}, dir{-10, 3}, eir{1032, 9000};

  ParamSpaceExplorer<3> pse3d({&c, &d, &e}, {cir, dir, eir}, {13, 5, 2});
