...
// numberCountsCardCPU is a class that models the concept of
...
public:
  ...
  explicit numberCountsCardCPU(cosmosis::DataBlock& config);
...
numberCountsCardCPU::numberCountsCardCPU(DataBlock& cfg)
{
  auto rc = 
  ...
  if (rc != DBS_SUCCESS) {
    throw std::runtime_error("numberCountsCardCPU failed to find do_cartesian_product_of_bins\n");
  }
}

void
numberCountsCardCPU::set_sample(DataBlock& sample)
{
...
void
numberCountsCardCPU::set_grid_point(grid_point_t grid_point)
{
                                ...
                                double lnM) const
{
  ...
  double const mor_v = (*mor)(lo, lnM, zt) * (*lc_lt)(lc, lt, zt);
...
std::vector<numberCountsCardCPU::volume_t>
numberCountsCardCPU::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
...
numberCountsCardCPU::grid_t
numberCountsCardCPU::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(numberCountsCardCPU)
