...
public:
  ...
  explicit avgMiscApprox1Card(cosmosis::DataBlock& config);
...
avgMiscApprox1Card::avgMiscApprox1Card( DataBlock& cfg)
{
  auto rc = 
...
void
avgMiscApprox1Card::set_sample(DataBlock& sample)
{
...
void
avgMiscApprox1Card::set_grid_point(
...
avgMiscApprox1Card::operator()(double lo,
                           double lt,
                           double zt,
                           double lnM,
                           double rmis,
...
char const*
avgMiscApprox1Card::module_label()
{
  return "gammaMisc";
}
...
std::vector<avgMiscApprox1Card::volume_t>
avgMiscApprox1Card::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cuda::make_integration_volumes_wall_of_numbers(
    cfg, avgMiscApprox1Card::module_label(),     
    "lo",
    "lt",
    "zt",
    "lnm",
...
avgMiscApprox1Card::grid_t
avgMiscApprox1Card::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(avgMiscApprox1Card)
