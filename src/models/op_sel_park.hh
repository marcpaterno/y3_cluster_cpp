  ...
  public:
    ...
    OP_SEL_PARK(double PI0_scalar, double R0_scalar, double c_scalar)
      : _PI0_val(PI0_scalar), _R0_val(R0_scalar), _c(c_scalar),
        _PI0(PI0_scalar, 0.0, 0.0), // Assuming B=1.0 and C=0.0 are default values
        _R0(R0_scalar, 0.0, 0.0) // Assuming B=1.0 and C=0.0 are default values
    {}
    ...
    double operator()(double r, double x, double z) const {
