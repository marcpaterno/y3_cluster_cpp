#ifndef Y3_CLUSTER_DSIGMA_MIS_CUH
#define Y3_CLUSTER_DSIGMA_MIS_CUH
...
namespace y3_cuda {
  ...
  public:
    ...
    DSIGMA_MIS(y3_cuda::NFW_DSIGMA_MIS const& nfw_DSIGMA_MIS,
    ...
    explicit DSIGMA_MIS(cosmosis::DataBlock& sample)
    ...
    /*r in h^-1 Mpc */ /* M in h^-1 M_solar, represents M_{200} */
    {
      ...
      double const sig_mis = _nfw_DSIGMA_MIS.clamp(r, _tau, lnM);
