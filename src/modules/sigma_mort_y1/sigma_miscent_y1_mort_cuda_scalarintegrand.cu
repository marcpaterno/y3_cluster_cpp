...
//
class SigmaMiscentY1MortCUDAScalarIntegrand {
public:
...
void
SigmaMiscentY1MortCUDAScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
SigmaMiscentY1MortCUDAScalarIntegrand::set_grid_point(grid_point_t grid_point)
{
...
char const*
SigmaMiscentY1MortCUDAScalarIntegrand::module_label()
{
  return "SigmaMiscentY1MortCUDAScalarIntegrand";
}
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(SigmaMiscentY1MortCUDAScalarIntegrand)
