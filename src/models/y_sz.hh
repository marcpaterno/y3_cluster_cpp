...
namespace y3_cluster {
    ...
    public:
        explicit Y_SZ(cosmosis::DataBlock& sample)
            : interp_1h()
            , interp_2h()
        {
            ...
            auto ys_1h = get_datablock<cosmosis::ndarray<double>>(sample,
                                                                  "cluster_sz",
                                                                  "ys_1h");
            auto ys_2h = get_datablock<cosmosis::ndarray<double>>(sample,
                                                                  "cluster_sz",
                                                                  "ys_2h");
