...
SigmaMiscentY1ScalarIntegrand::make_integration_volumes(cosmosis::DataBlock& cfg)
{
...
SigmaMiscentY1ScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_grid_points_cartesian_product(
    cfg, SigmaMiscentY1ScalarIntegrand::module_label(), "zo_low", "zo_high", "radii");
}

DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(SigmaMiscentY1ScalarIntegrand)
