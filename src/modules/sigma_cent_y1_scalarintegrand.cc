...
// SigmaCentY1ScalarIntegrand is a class that models the concept of
...
//
//
class SigmaCentY1ScalarIntegrand {
public:
...
public:
  ...
  explicit SigmaCentY1ScalarIntegrand(cosmosis::DataBlock& config);
...
SigmaCentY1ScalarIntegrand::SigmaCentY1ScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
SigmaCentY1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
SigmaCentY1ScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
double
SigmaCentY1ScalarIntegrand::operator()(double lo,
                             double lt,
                             double zt,
                             double lnM) const
{
...
char const*
SigmaCentY1ScalarIntegrand::module_label()
{
  return "SigmaCentY1ScalarIntegrand";
}
...
std::vector<SigmaCentY1ScalarIntegrand::volume_t>
SigmaCentY1ScalarIntegrand::make_integration_volumes(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, SigmaCentY1ScalarIntegrand::module_label(), "lo","lt", "zt", "lnm");
}

std::vector<SigmaCentY1ScalarIntegrand::grid_point_t>
SigmaCentY1ScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_grid_points_cartesian_product(
    cfg, SigmaCentY1ScalarIntegrand::module_label(), "zo_low", "zo_high", "radii");
}

DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(SigmaCentY1ScalarIntegrand)
