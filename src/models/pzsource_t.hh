...
namespace y3_cluster {
  ...
  public:
    ...
    explicit PZSOURCE_t(cosmosis::DataBlock& sample,
      ...
      : pzsources(pzsources)
      , zoffsets{get_datablock<double>(sample, "cluster_abundance", "pzsource_offset_1"),
                 ...
                 get_datablock<double>(sample, "cluster_abundance", "pzsource_offset_4")}
    {
      if (pzsources.size() != zoffsets.size())
        throw std::runtime_error("number of zsource distributions and number of offsets do not match");
    }
