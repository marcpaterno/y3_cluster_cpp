...
void
summedNumbersMiscentY1::set_grid_point(grid_point_t const& grid_point)
{
...
summedNumbersMiscentY1::make_grid_points(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_grid_points_wall_of_numbers(
    cfg, summedNumbersMiscentY1::module_label(), "zo_low", "zo_high");
}

DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(summedNumbersMiscentY1)
