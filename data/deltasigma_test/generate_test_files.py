...
if __name__ == "__main__":
  ...
  dirname = os.path.expandvars('${Y3_CLUSTER_CPP_DIR}/data/matter_power_nl')
  ...
  dirname = os.path.expandvars('${Y3_CLUSTER_CPP_DIR}/data/deltasigma_test')
  ...
  dirname = os.path.expandvars('${Y3_CLUSTER_CPP_DIR}/data/matter_power_lin')
  klin = np.loadtxt(os.path.join(dirname, "k_h.txt"))
  Plin = np.loadtxt(os.path.join(dirname, "p_k.txt"))
  zz = np.loadtxt(os.path.join(dirname, "z.txt"))
  ff=open(os.path.expandvars('${Y3_CLUSTER_CPP_DIR}/data/deltasigma_test/bias.txt'), 'w')
