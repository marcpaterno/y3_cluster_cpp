...
// NCCentY1MortScalarIntegrand is a class that models the concept of
...
//
//
class NCCentY1MortScalarIntegrand {
public:
...
public:
  ...
  explicit NCCentY1MortScalarIntegrand(cosmosis::DataBlock& config);
...
NCCentY1MortScalarIntegrand::NCCentY1MortScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
NCCentY1MortScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
NCCentY1MortScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
char const*
NCCentY1MortScalarIntegrand::module_label()
{
  return "NCCentY1MortScalarIntegrand";
}
...
std::vector<NCCentY1MortScalarIntegrand::volume_t>
...
std::vector<NCCentY1MortScalarIntegrand::grid_point_t>
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(NCCentY1MortScalarIntegrand)
