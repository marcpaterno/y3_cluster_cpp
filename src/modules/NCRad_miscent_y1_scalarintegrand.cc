...
// NCRadMiscentY1ScalarIntegrand is a class that models the concept of
...
//
//
class NCRadMiscentY1ScalarIntegrand {
public:
...
public:
  ...
  explicit NCRadMiscentY1ScalarIntegrand(cosmosis::DataBlock& config);
...
NCRadMiscentY1ScalarIntegrand::NCRadMiscentY1ScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
NCRadMiscentY1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
NCRadMiscentY1ScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
double
NCRadMiscentY1ScalarIntegrand::operator()(double lo,
                             double lc,
                             double lt,
                             double zt,
                             double lnM) const
...
char const*
NCRadMiscentY1ScalarIntegrand::module_label()
{
  return "NCRadMiscentY1ScalarIntegrand";
}
...
std::vector<NCRadMiscentY1ScalarIntegrand::volume_t>
NCRadMiscentY1ScalarIntegrand::make_integration_volumes(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, NCRadMiscentY1ScalarIntegrand::module_label(), "lo", "lc", "lt", "zt", "lnm");
}

std::vector<NCRadMiscentY1ScalarIntegrand::grid_point_t>
NCRadMiscentY1ScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_grid_points_cartesian_product(
    cfg, NCRadMiscentY1ScalarIntegrand::module_label(), "zo_low", "zo_high", "rmis_array");
}

DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(NCRadMiscentY1ScalarIntegrand)
