...
y3_cluster::sinusoid_polynomial_taylor_approx(int n, const double range_min, const double range_max)
{
...
std::pair<double, double>
y3_cluster::sinusoid_polynomial_integral(int n, const double range_min, const double range_max)
{
...
y3_cluster::sinusoid_polynomial_integrals(int minn, int maxn, const double range_min, const double range_max)
{
    if (minn > maxn)
