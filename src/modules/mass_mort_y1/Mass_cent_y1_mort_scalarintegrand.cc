...
// MassCentY1MortScalarIntegrand is a class that models the concept of
...
//
//
class MassCentY1MortScalarIntegrand {
public:
...
public:
  ...
  explicit MassCentY1MortScalarIntegrand(cosmosis::DataBlock& config);
...
MassCentY1MortScalarIntegrand::MassCentY1MortScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
MassCentY1MortScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
MassCentY1MortScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
double
MassCentY1MortScalarIntegrand::operator()(double lo,
                             double zt,
                             double lnM) const
{
...
char const*
MassCentY1MortScalarIntegrand::module_label()
{
  return "MassCentY1MortScalarIntegrand";
}
...
std::vector<MassCentY1MortScalarIntegrand::volume_t>
MassCentY1MortScalarIntegrand::make_integration_volumes(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, MassCentY1MortScalarIntegrand::module_label(), "lo", "zt", "lnm");
}

std::vector<MassCentY1MortScalarIntegrand::grid_point_t>
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(MassCentY1MortScalarIntegrand)
