 ...
 * (https://arxiv.org/pdf/1703.06428.pdf), Section 4
 *
 *  I^n_l = A_{nl} X_{n - l - 1} + \sum_{i = 0}^{l - 1} B^n_{li} x^{n - l + 1 +
 * i} j_i A_{nl} = \product_{k = 0}^{l - 1} (l + n - 2k - 1) B^n_{li} =
 * \product_{k = 0}^{l - i - 1} (l + n - 2k - 1)
 *
...
namespace y3_cluster {
  ...
  double bessel_polynomial_integral(int n,
                                    unsigned l,
                                    double k,
                                    double range_min,
                                    double range_max);
  ...
  std::vector<double> bessel_polynomial_integrals(int n,
                                                  unsigned maxl,
                                                  double k,
                                                  double range_min,
                                                  double range_max);
