...
// MassCentY1ScalarIntegrand is a class that models the concept of
...
public:
  ...
  explicit MassCentY1ScalarIntegrand(cosmosis::DataBlock& config);
...
MassCentY1ScalarIntegrand::MassCentY1ScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
MassCentY1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
MassCentY1ScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
char const*
MassCentY1ScalarIntegrand::module_label()
{
  return "MassCentY1ScalarIntegrand";
}
...
std::vector<MassCentY1ScalarIntegrand::volume_t>
...
MassCentY1ScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_grid_points_cartesian_product(
    cfg, MassCentY1ScalarIntegrand::module_label(), "zo_low", "zo_high");
}

DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(MassCentY1ScalarIntegrand)
