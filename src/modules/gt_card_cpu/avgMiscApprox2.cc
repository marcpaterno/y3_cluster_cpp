...
public:
  ...
  explicit avgMiscApprox2CardCPU(cosmosis::DataBlock& config);
...
avgMiscApprox2CardCPU::avgMiscApprox2CardCPU( DataBlock& cfg)
{
  auto rc = 
...
void
avgMiscApprox2CardCPU::set_sample(DataBlock& sample)
{
...
void
avgMiscApprox2CardCPU::set_grid_point(
...
double
avgMiscApprox2CardCPU::operator()(double lo,
                                          double lt,
                                          double zt,
                                          double lnM) const
{
  ...
  auto const val = (*gamma)(radius_, lnM, zt) * (*lc_lt)(lc, lt, zt) *
...
char const*
avgMiscApprox2CardCPU::module_label()
{
  return "gammaMisc";
}
...
std::vector<avgMiscApprox2CardCPU::volume_t>
avgMiscApprox2CardCPU::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgMiscApprox2CardCPU::module_label(), "lo", "lt", "zt", "lnm");
}

avgMiscApprox2CardCPU::grid_t
avgMiscApprox2CardCPU::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgMiscApprox2CardCPU)
