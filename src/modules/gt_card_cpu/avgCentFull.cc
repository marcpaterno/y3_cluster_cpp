...
public:
  ...
  explicit avgCentCardCPU(cosmosis::DataBlock& config);
...
avgCentCardCPU::avgCentCardCPU( DataBlock& cfg)
{
  auto rc = 
...
void
avgCentCardCPU::set_sample(DataBlock& sample)
{
...
double
avgCentCardCPU::operator()( double lo,
                            double lt,
                            double zt,
                            double lnM) const
{
...
std::vector<avgCentCardCPU::volume_t>
avgCentCardCPU::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgCentCardCPU::module_label(), "lo", "lt", "zt", "lnm");
}

avgCentCardCPU::grid_t
avgCentCardCPU::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgCentCardCPU)
