...
// NCMiscentY1ScalarIntegrand is a class that models the concept of
...
//
//
class NCMiscentY1ScalarIntegrand {
public:
...
public:
  ...
  explicit NCMiscentY1ScalarIntegrand(cosmosis::DataBlock& config);
...
NCMiscentY1ScalarIntegrand::NCMiscentY1ScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
NCMiscentY1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
NCMiscentY1ScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
double
NCMiscentY1ScalarIntegrand::operator()(double lo,
                             double lc,
                             double lt,
                             double zt,
                             double lnM,
...
char const*
NCMiscentY1ScalarIntegrand::module_label()
{
  return "NCMiscentY1ScalarIntegrand";
}
...
std::vector<NCMiscentY1ScalarIntegrand::volume_t>
NCMiscentY1ScalarIntegrand::make_integration_volumes(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, NCMiscentY1ScalarIntegrand::module_label(), "lo", "lc", "lt", "zt", "lnm", "rmis");
}

std::vector<NCMiscentY1ScalarIntegrand::grid_point_t>
NCMiscentY1ScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_grid_points_cartesian_product(
    cfg, NCMiscentY1ScalarIntegrand::module_label(), "zo_low", "zo_high", "radii");
}

DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(NCMiscentY1ScalarIntegrand)
