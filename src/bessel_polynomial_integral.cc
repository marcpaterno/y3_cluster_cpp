...
double
y3_cluster::bessel_polynomial_integral(const int n, const unsigned l, const double k,
                                       const double range_min, const double range_max)
{
...
std::vector<double>
y3_cluster::bessel_polynomial_integrals(const int n, const unsigned maxl, const double k,
                                        const double range_min, const double range_max)
{
