...
public:
  ...
  explicit avgGammaProjBu(cosmosis::DataBlock& config);
...
avgGammaProjBu::avgGammaProjBu( DataBlock& cfg)
{
  auto rc = 
...
void
avgGammaProjBu::set_sample(DataBlock& sample)
{
...
avgGammaProjBu::operator()(   double lo,
                              double zt,
                              double lnM) const
{
...
std::vector<avgGammaProjBu::volume_t>
avgGammaProjBu::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cuda::make_integration_volumes_wall_of_numbers(
    cfg, avgGammaProjBu::module_label(), "lo", "zt", "lnm");
}

avgGammaProjBu::grid_t
avgGammaProjBu::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(avgGammaProjBu)
