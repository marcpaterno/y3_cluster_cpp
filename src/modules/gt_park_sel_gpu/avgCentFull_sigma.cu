...
public:
  ...
  explicit avgCentSigmaPark(cosmosis::DataBlock& config);
...
avgCentSigmaPark::avgCentSigmaPark( DataBlock& cfg)
{
  auto rc = 
...
void
avgCentSigmaPark::set_sample(DataBlock& sample)
{
...
void
avgCentSigmaPark::set_grid_point(
...
char const*
avgCentSigmaPark::module_label()
{
  return "sigmaCentPark";
}
...
std::vector<avgCentSigmaPark::volume_t>
avgCentSigmaPark::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
...
avgCentSigmaPark::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(avgCentSigmaPark)
