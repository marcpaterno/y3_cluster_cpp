...
using y3_cluster::IntegrationRange, y3_cluster::test_integrate_lc_lt;
int
main(int argc, char** argv)
{
  ...
  auto args_parser =
    Opt(lc_min,
        "lc min")["--lc-min"]("Lower integration bound of \\lambda_c values") |
    Opt(lc_max,
        "lc max")["--lc-max"]("Upper integration bound of \\lambda_c values") |
    Opt(lt_min, "lt min")["--lt-min"](
      "Lower bound of \\lambda_t values to integrate at") |
    Opt(lt_max, "lt max")["--lt-max"](
    ...
    Opt(lt_width, "lt width")["--lt-width"](
