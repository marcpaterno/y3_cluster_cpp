...
// MassMiscentY1ScalarIntegrand is a class that models the concept of
...
public:
  ...
  explicit MassMiscentY1ScalarIntegrand(cosmosis::DataBlock& config);
...
MassMiscentY1ScalarIntegrand::MassMiscentY1ScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
MassMiscentY1ScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
MassMiscentY1ScalarIntegrand::set_grid_point(grid_point_t const& grid_point)
{
...
{
  return "MassMiscentY1ScalarIntegrand";
}
...
std::vector<MassMiscentY1ScalarIntegrand::volume_t>
