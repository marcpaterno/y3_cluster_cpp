...
//
class avgCentFullScalarIntegrand {
public:
...
public:
  ...
  explicit avgCentFullScalarIntegrand(cosmosis::DataBlock& config);
...
avgCentFullScalarIntegrand::avgCentFullScalarIntegrand( DataBlock& cfg)
{
  auto rc = 
...
void
avgCentFullScalarIntegrand::set_sample(DataBlock& sample)
{
...
void
avgCentFullScalarIntegrand::set_grid_point(
...
double
avgCentFullScalarIntegrand::operator()(  double lo,
                              double zt,
                              double lnM) const
{
...
char const*
avgCentFullScalarIntegrand::module_label()
{
  return "gammaCent";
}
...
std::vector<avgCentFullScalarIntegrand::volume_t>
avgCentFullScalarIntegrand::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgCentFullScalarIntegrand::module_label(), "lo", "zt", "lnm");
}

avgCentFullScalarIntegrand::grid_t
avgCentFullScalarIntegrand::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgCentFullScalarIntegrand)
