...
#include "models/int_lc_lt_des_t.cu"
...
public:
  ...
  explicit avgMiscFullCard(cosmosis::DataBlock& config);
...
avgMiscFullCard::avgMiscFullCard( DataBlock& cfg)
{
  auto rc = 
...
void
avgMiscFullCard::set_sample(DataBlock& sample)
{
...
void
avgMiscFullCard::set_grid_point(
...
avgMiscFullCard::operator()(double lo,
                        double lc,
                        double lt,
                        double zt,
                        double lnM,
                        ...
                        double theta) const
{
  ...
  auto const val = (*gamma)(scaled_Rmis, lnM, zt) * roffset_v * 
                   (*lo_lc)(lo, lc, rmis) * (*lc_lt)(lc, lt, zt) *
...
std::vector<avgMiscFullCard::volume_t>
avgMiscFullCard::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
  return y3_cuda::make_integration_volumes_wall_of_numbers(
    cfg, avgMiscFullCard::module_label(),     
    "lo",
    "lc",
    "lt",
    "zt",
...
avgMiscFullCard::grid_t
avgMiscFullCard::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(avgMiscFullCard)
