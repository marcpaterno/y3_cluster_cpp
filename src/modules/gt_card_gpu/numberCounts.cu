...
// numberCountsCard is a class that models the concept of
...
numberCountsCard::numberCountsCard(DataBlock& cfg)
{
  auto rc = 
  ...
  if (rc != DBS_SUCCESS) {
    throw std::runtime_error("numberCountsCard failed to find do_cartesian_product_of_bins\n");
  }
}

void
numberCountsCard::set_sample(DataBlock& sample)
{
...
void
numberCountsCard::set_grid_point(grid_point_t grid_point)
{
...
std::vector<numberCountsCard::volume_t>
numberCountsCard::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
...
numberCountsCard::grid_t
numberCountsCard::make_grid_points(cosmosis::DataBlock& cfg)
{
