...
// NCRadMiscentY1MortScalarIntegrand is a class that models the concept of
...
//
//
class NCRadMiscentY1MortScalarIntegrand {
public:
...
public:
  ...
  explicit NCRadMiscentY1MortScalarIntegrand(cosmosis::DataBlock& config);
...
NCRadMiscentY1MortScalarIntegrand::NCRadMiscentY1MortScalarIntegrand(DataBlock&)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
...
void
NCRadMiscentY1MortScalarIntegrand::set_sample(DataBlock& sample)
{
...
{
  return "NCRadMiscentY1MortScalarIntegrand";
}
...
std::vector<NCRadMiscentY1MortScalarIntegrand::grid_point_t>
