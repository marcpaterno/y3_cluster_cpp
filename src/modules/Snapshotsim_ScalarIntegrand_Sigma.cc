...
// Snapshotsim_ScalarIntegrand_Sigma is a class that models the concept of
...
public:
  ...
  explicit Snapshotsim_ScalarIntegrand_Sigma(cosmosis::DataBlock& config);
...
void
Snapshotsim_ScalarIntegrand_Sigma::set_sample(DataBlock& sample)
{
...
double
Snapshotsim_ScalarIntegrand_Sigma::operator()(double /* lt */, double lnM) const
{
...
//
void
Snapshotsim_ScalarIntegrand_Sigma::finalize_sample(
  cosmosis::DataBlock& sample,
  std::vector<grid_point_t> const& grid_points,
  std::size_t nvolumes,
...
std::vector<Snapshotsim_ScalarIntegrand_Sigma::grid_point_t>
