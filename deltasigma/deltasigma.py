...
def execute(block, config):
	...
	logM = np.log(M)
	block[cosmo, "Xi_1"] = Xi_1
	block[cosmo, "Xi_2"] = Xi_2
	block[cosmo, "R_Xi"] = Radii
	block[cosmo, "deltasigma_1"] = Deltasigma_1
	block[cosmo, "deltasigma_2"] = Deltasigma_2
	block[cosmo, "sigma_1"] = Sigma_1
	block[cosmo, "sigma_2"] = Sigma_2
	block[cosmo, "bias"] = Bias
	block[cosmo, "m_h"] = M
	block[cosmo, "z"] = z
	block[cosmo, "lnM"] = logM
	block[cosmo, "R_sigma_deltasigma"] = R_perp
	return 0
