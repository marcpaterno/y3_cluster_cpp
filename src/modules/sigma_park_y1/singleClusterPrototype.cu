...
// singleClusterPrototype is a class that models the concept of
...
public:
  ...
  explicit singleClusterPrototype(cosmosis::DataBlock& config);
  ...
  __host__ __device__ double operator()(double lt,
                                        double zt,
                                        double lnM,
                                        double lc,
                                        double rmis,
...
singleClusterPrototype::singleClusterPrototype(DataBlock& cfg)
{
  auto rc =
...
void
singleClusterPrototype::set_sample(DataBlock& sample)
{
...
void
singleClusterPrototype::set_grid_point(grid_point_t grid_point)
{
...
singleClusterPrototype::operator()(   double lt,
                                      double zt,
                                      double lnM,
                                      double lc,
                                      double rmis,
...
char const*
singleClusterPrototype::module_label()
{
  return "singleClusterPrototype";
}

std::vector<singleClusterPrototype::volume_t>
singleClusterPrototype::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
...
singleClusterPrototype::grid_t
singleClusterPrototype::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(singleClusterPrototype)
