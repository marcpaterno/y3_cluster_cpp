#ifndef Y3_CLUSTER_DSIGMA_MIS_JOINT_CUH
#define Y3_CLUSTER_DSIGMA_MIS_JOINT_CUH
...
namespace y3_cuda {
  ...
  public:
    ...
    explicit DSIGMA_MIS_JOINT(cosmosis::DataBlock& sample)
    ...
    /*r in h^-1 Mpc */ /* M in h^-1 M_solar, represents M_{200} */
    {
      ...
      double const sig_mis_1 = _nfw_dsigma_mis.clamp(r, _tau, lnM);
