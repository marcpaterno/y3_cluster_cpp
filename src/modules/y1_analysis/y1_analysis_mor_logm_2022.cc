...
// y1_analysis_mor_logm_2022 is a class that models the concept of "CosmoSISIntegrand",
...
//
//
class y1_analysis_mor_logm_2022 {
private:
...
public:
  ...
  explicit y1_analysis_mor_logm_2022(cosmosis::DataBlock& config);
...
y1_analysis_mor_logm_2022::y1_analysis_mor_logm_2022(DataBlock& config)
  : lc_lt()
  , mor()
  , omega_z()
  , dv_do_dz()
  ...
  , int_zo_zt()
  , zo_low_(
      config.view<std::vector<double>>(y1_analysis_mor_logm_2022::module_label(), "zo_low"))
  , zo_high_(
      config.view<std::vector<double>>(y1_analysis_mor_logm_2022::module_label(), "zo_high"))
{}

void
y1_analysis_mor_logm_2022::set_sample(DataBlock& sample)
{
...
std::vector<double>
y1_analysis_mor_logm_2022::operator()(double lo, double zt, double lnM) const
{
...
//
void
y1_analysis_mor_logm_2022::finalize_sample(
  cosmosis::DataBlock& sample,
...
char const*
y1_analysis_mor_logm_2022::module_label()
{
  return "y1_analysis_mor_logm_2022";
}
...
std::vector<y1_analysis_mor_logm_2022::volume_t>
y1_analysis_mor_logm_2022::make_integration_volumes(cosmosis::DataBlock& cfg)
{
  try {
...
DEFINE_COSMOSIS_VECTOR_INTEGRATION_MODULE(y1_analysis_mor_logm_2022)
