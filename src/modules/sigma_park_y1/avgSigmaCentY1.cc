...
void
avgSigmaCentY1::set_grid_point(grid_point_t const& grid_point)
{
  ...
  cosmosis::DataBlock& cfg)
{
  return y3_cluster::make_integration_volumes_wall_of_numbers(
    cfg, avgSigmaCentY1::module_label(), "lo", "zt", "lnm");
}
...
DEFINE_COSMOSIS_SCALAR_INTEGRATION_MODULE(avgSigmaCentY1)
