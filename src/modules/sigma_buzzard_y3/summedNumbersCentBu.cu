...
// summedNumbersCentBu is a class that models the concept of
...
public:
  ...
  explicit summedNumbersCentBu(cosmosis::DataBlock& config);
...
summedNumbersCentBu::summedNumbersCentBu(DataBlock& cfg)
{
  auto rc = 
  ...
  if (rc != DBS_SUCCESS) {
    throw std::runtime_error("summedNumbersCentBu failed to find do_cartesian_product_of_bins\n");
  }
}

void
summedNumbersCentBu::set_sample(DataBlock& sample)
{
...
void
summedNumbersCentBu::set_grid_point(grid_point_t grid_point)
{
...
summedNumbersCentBu::operator()(double lo,
                                double zt,
                                double lnM) const
{
...
std::vector<summedNumbersCentBu::volume_t>
summedNumbersCentBu::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
...
summedNumbersCentBu::grid_t
summedNumbersCentBu::make_grid_points(cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(summedNumbersCentBu)
