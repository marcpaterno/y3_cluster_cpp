...
namespace y3_cluster {
    ...
    public:
        ln_mez_power_law(double A, double B, double C, double lnMp, double zp,
                         cosmosis::DataBlock& sample)
            : log_A_(std::log(A)), B_(B), C_(C), lnMp_(lnMp)
        ...
        double operator()(double lnM, double z) const {
            return log_A_ + B_ * (lnM - lnMp_) 
