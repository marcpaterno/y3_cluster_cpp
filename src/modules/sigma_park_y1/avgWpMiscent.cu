...
public:
  ...
  explicit avgWpMiscent(cosmosis::DataBlock& config);
...
avgWpMiscent::avgWpMiscent( DataBlock& cfg)
{
  auto rc =
...
void
avgWpMiscent::set_sample(DataBlock& sample)
{
...
void
avgWpMiscent::set_grid_point(grid_point_t grid_point)
{
...
std::vector<avgWpMiscent::volume_t>
avgWpMiscent::make_integration_volumes(
  cosmosis::DataBlock& cfg)
{
...
DEFINE_COSMOSIS_CUDA_INTEGRATION_MODULE(avgWpMiscent)
